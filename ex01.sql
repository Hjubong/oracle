...
/*
Oracle Databse 11g Enterprise Edition(기업용)
Oracle Databse 11g Express Edition(무료, 교육용)
...
1. DBMS 제작사와 독립적이다
    ...
    - DMBS 제작사에서 SQL라는 언어를 자신의 제품을 적용
...
2. DML
    ...
    - CRUD
    - 사용 빈도가 가장 높음
    a. SELECT: 조회(읽기) > R read
    b. INSERT: 추가(생성) > C create
    c. UPDATE: 수정 > U
    d. DELETE: 삭제 > D
    - 데이터베이스 관리자
    - 데이터베이스 담당자
