...
/*
	...
	INSERT 구문
	- insert into 테이블명 (컬럼리스트) values (컬럼리스트);
...
INSERT INTO TBLMEMO (seq, memo, regdate, name) VALUES (seqMemo.nextVal, '홍길동', '메모입니다.', sysdate);
...
INSERT INTO TBLMEMO VALUES (seqMemo.nextVal, sysdate , '메모입니다.', '홍길동');
-- null 컬럼은 생략 불가능
